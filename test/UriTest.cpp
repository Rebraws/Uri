...
auto UriTest::SetUp() -> void
{
  ...
  mTestCases = std::vector<TestCase>{ TestCase{ "https://www.example.com",
                                        "www.example.com"s,
                                        "https"s,
                                        {},
                                        ""s,
    ...
    TestCase{ "http://rebraws@www.example.com:80/foo/bar?query=foo#bar",
      ...
      Error::OK },
    TestCase{
      "ldap://[2001:0db8:85a3:0000:0000:8a2e:0370:7334]/c=GB?objectClass?one",
      ...
      0,
      Error::OK },
    TestCase{ "ldap://[2001:0db8:85a3:0000:0000:8a2e:0370:7334]:8080/"
              "c=GB?objectClass?two",
